...
// Label da seção
$section_label = vana_t('vod.section_label', $lang);
?>
      ...
      >
        ...
        <a
          ...
          aria-label="<?php echo esc_attr(
            vana_t('vod.watch_prefix', $lang) . $vod_title
            . ($is_active ? vana_t('vod.selected', $lang) : '')
          ); ?>"
          aria-current="<?php echo $is_active ? 'true' : 'false'; ?>"
          hx-get="<?php echo esc_url(rest_url('vana/v1/stage-fragment')); ?>"
          hx-vals='{"visit_id":<?php echo (int)$visit_id; ?>,"item_id":<?php echo (int)($vod["id"] ?? 0); ?>,"item_type":"vod","lang":"<?php echo esc_attr($lang); ?>"}'
          hx-target="#vana-stage-wrapper"
          hx-swap="innerHTML transition:true"
          hx-push-url="<?php echo esc_url($card_url); ?>"
          ...
          <div class="vana-card__media">
            ...
            <?php if ($is_active): ?>
              <div style="
                ...
                z-index:        2;
              " aria-hidden="true">
                <?php echo esc_html(vana_t('vod.playing', $lang)); ?>
              </div>
            <?php endif; ?>
            ...
            <?php if ($duration): ?>
              <div style="
                ...
                z-index:        2;
              " aria-label="<?php echo esc_attr(vana_t('vod.duration_prefix', $lang) . $duration); ?>">
